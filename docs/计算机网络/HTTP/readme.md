...
http1.1 的排队问题，三个请求，共用一个请求，解决了排队问题

### 防止对头阻塞

文件 1 阻塞，文件 2 也阻塞。共用一个请求，类似并发
...
:::tip
可能发生阻塞，100 个 js 文件，先发送了图片，导致阻塞
:::
服务端读取 index.html 的时候，服务端了解到里面需要很多 jscss 文件，这些也一起发送过来

### HTTP3.0
在http和UDP中新增一个QUIC保证UDP的安全